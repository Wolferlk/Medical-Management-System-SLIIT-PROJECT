...
<body class="body" style="background-image: url('img/cnt1.jpg')"> 
...
-->
    ...
    <section class="contact-form">
        <div class="form-container">
            <h2>Send Message</h2>
            <form action="setContactServlet" method="POST">
                ...
                <button type="submit" class="submit-button">Submit</button></form><br>
